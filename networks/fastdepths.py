...
class NNConv(nn.Module):
    ...
    def __init__(self, kernel_size, dw):
        ...
        if dw:
            ...
            self.conv10=depthwise(1024, kernel_size)
            self.conv11 = pointwise(1024, 512)


            self.conv20 = depthwise(512, kernel_size)
            self.conv21 = pointwise(512, 256)
            self.conv30 = depthwise(256, kernel_size)
            self.conv31 = pointwise(256, 128)
            self.conv40 = depthwise(128, kernel_size)
            self.conv41 = pointwise(128, 64)
            self.conv50 = depthwise(64, kernel_size)
            self.conv51 = pointwise(64, 32)
...
def choose_decoder(decoder='upconv'):
